...
%\thispagestyle{empty}
\begin{flushright}
	\null\vspace{\stretch {1.5}}
	A te, fra vent'anni.\\
	\vspace{10pt}
	Luca\\
	\vspace{\stretch {6}}
	Questa tesi è dedicata a Roberto,\\che mi ha ispirato a diventare ingegnere.\\
	\vspace{10pt}
	Andrea\\
	\vspace{\stretch {2}}
\end{flushright}
...
\begin{center}
	\section*{\centering Ringraziamenti}
		Ringrazio il professor Berta, per la disponibilità e la cordialità dimostrate nel corso di questi mesi.
